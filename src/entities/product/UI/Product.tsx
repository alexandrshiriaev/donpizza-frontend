...
export const Product = ({
    ...
    return (
        <div className="relative bg-white rounded-2xl relative overflow-hidden">
            {tag && (
                <div
            ...
            <footer className="absolute left-0 right-0 bottom-0 flex justify-between items-center px-8 py-8">
                {footer}
            </footer>
        </div>
    );
